...
import FootballApp from "./images/FootballApp.PNG"
  ...
  <>
        ...
        <section id="projects" className="projects">
            ...
            <ul className="project-list">
                <li className="project">
                    <div className="project-image"><img className="thumbnail" src={ChatApp}/></div>
                    <div className="project-content">
                        ...
                        <div className="project-links">
                            <a className="github" href="https://github.com/Jaxu01/Chat-React-MERN-App" aria-label="GitHub" target="_blank">
                                <svg className="github-project media-icon-project feather feather-github" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><title>GitHub</title><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path></svg>
                            </a>
                            <a className="external-link" href="https://warm-retreat-87623.herokuapp.com" aria-label="External Link" target="_blank">
                                <svg className="external-link-project media-icon-project feather feather-external-link" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><title>External Link</title><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path><polyline points="15 3 21 3 21 9"></polyline><line x1="10" y1="14" x2="21" y2="3"></line></svg>
                            </a>
                        </div>
                    </div>
                </li>
                <li className="project project-align-right">
                <div className="project-image"><img className="thumbnail" src={FootballApp}/></div>
                    <div className="project-content">
                        <div className="project-details">
                            <h3 className="project-title">
                ...
                <li className="project">
                    <div className="project-image"><img className="thumbnail" src={WeatherApp}/></div>
                    <div className="project-content">
                        <div className="project-details">
                            <h3 className="project-title">
                                <a className="image-github" href="https://github.com/Jaxu01/Weather-React-App" target="_blank">Weather App</a>
                            </h3>
                        ...
                        <div className="project-links">
                            <a className="github" href="https://github.com/Jaxu01/Weather-React-App" aria-label="GitHub" target="_blank">
                                <svg className="github-project media-icon-project feather feather-github" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><title>GitHub</title><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path></svg>
                            </a>
                ...
                <li className="project project-align-right">
                    <div className="project-image"><img className="thumbnail" src={ToDoList}/></div>
                    <div className="project-content">
                        <div className="project-details">
                            <h3 className="project-title">
                ...
                <li className="project">
                    <div className="project-image"><img className="thumbnail" src={ContactForm}/></div>
                    <div className="project-content">
                        <div className="project-details">
                            <h3 className="project-title">
    ...
    <div className="media-container">
        <a className="github" href="https://github.com/Jaxu01" aria-label="GitHub" target="_blank">
            <svg className="github-icon media-icon feather feather-github" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><title>GitHub</title><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path></svg>
        </a>
        <a className="linkedin" href="https://www.linkedin.com/in/jakub-piwtorak-79a013227/" aria-label="LinkedIn" target="_blank">
            <svg className="linkedin-icon media-icon feather feather-linkedin" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><title>LinkedIn</title><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle></svg>
        </a>
    </div>
